...
# Code chunks are clearly labeled and beautifully organized! - EJL
# Code is clearly written; it is clear to read and understand, neat and tidy (no pun intended) - EJL
# I like how you visualized race and ethnicity separately. - EJL
# I learned how to clean and collapse multiple race-check-box variables into one labeled categorical race variable. - EJL
# There could be more consistency with capitalization across section headers - EJL
# I could not get the code to render. - EJL
```
...
gtsave(race_ethnicity_table, filename = "race_ethnicity_table.png")
