...
# Here, I initially thought that fct_recode would look a little bit cleaner than the ifelse statements, but I learned that fct_recode only works with character vectors or vectors, not numeric vectors. I've added code for a possible use of fct_recode for the "employed" columng!
