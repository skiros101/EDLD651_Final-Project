...
var_label(wave5_clean$insurance_status)<-"Insurance Status (h5id9)"
var_label(wave5_clean$reason_a_not_offered_thru_work_or_school)<-"Reason A: Not Offered thru work/ school (h5id10a)"
var_label(wave5_clean$reason_b_too_expensive)<-"Reason B: Too Expensive (h5id10b)"
var_label(wave5_clean$reason_c_no_need_or_want)<-"Reason C: No Need or Want (h5id10c)"
var_label(wave5_clean$reason_d_denied_insurance)<-"Reason D: Denied Insurance (h5id10d)"
...
wave5_clean <- wave5_clean %>%
  mutate(across(
    c(
      reason_a_not_offered_thru_work_or_school,
      reason_b_too_expensive ,
      reason_c_no_need_or_want,
      reason_d_denied_insurance
    ),
    ~ factor(
      .,
      levels = c(0, 1, 97),
...
#WORK IN PROGRESS_Collapsing Income variable

wave5_clean<- wave5_clean %>%
  mutate(
    household_income2 = fct_collapse(household_income,
      zero_to_twenty_k = c("Less than $5,000", "$5,000 to $9,999", "$10,000 to $14,999", "$15,000 to $19,999"),
      twenty_k_to_fifty_k = c(,
      "$20,000 to $24,999",
      "$25,000 to $29,999",
      "$30,000 to $39,999",
      "$40,000 to $49,999"), 
      fifty_k_to_200_and_more=  c("$50,000 to $74,999",
        "$75,000 to $99,999",
        "$100,000 to $149,999",
        "$150,000 to $199,999",
        "$200,000 or more")))
